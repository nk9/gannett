    ...
    return (
        <Container maxWidth="sm">
            <Box sx={{ my: 4 }} className={styles.content}>
                ...
                <Typography variant='body1'>
                    I got to work, and a few months later Gannett was born. I named it after <Link href="https://www.census.gov/history/www/census_then_now/notable_alumni/henry_gannett.html">Henry Gannett</Link>, a geographer for the US Census in the 19th Century, and Chairman of the <Link href="https://en.wikipedia.org/wiki/United_States_Board_on_Geographic_Names">US Board of Geographic Names</Link> for many years. I'm pleased to be able to pay homage to a geographer for this geography project!
                </Typography>
            </Box>
        </Container >
    );
