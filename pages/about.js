        ...
        <Container maxWidth="sm">
            <Box sx={{ my: 4 }} className={styles.content}>
                ...
                <Typography variant='body1'>
                    Every genealogist who has family in the United States after the mid-19th Century will have encountered Enumeration Districts, even if they don't realize it.
                </Typography>
                <Typography variant='body1'>
